// Path: web/assets/modules/ui/components/parallels/parallels_resize.js
export const ParallelsResize = {
    _getDeviceSuffix() {
    ...
    _loadSavedDimensions(menu) {
        if (!menu) return;
        try {
            const key = `parallels_panel_size${this._getDeviceSuffix()}`;
            ...
            console.warn("Failed to load Parallels dimensions", e);
        }
    },

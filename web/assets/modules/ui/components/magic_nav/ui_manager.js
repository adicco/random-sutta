...
export const UIManager = {
    ...
    init() {
        this.elements = {
            ...
            tabToc: document.getElementById("tab-magic-toc"),
            tabHeadings: document.getElementById("tab-magic-headings"),
            ...
            headingsContent: document.getElementById("magic-headings-content"),
            headingsList: document.getElementById("magic-headings-list"),
            bookmarksContent: document.getElementById("magic-bookmarks-content"),
            readContent: document.getElementById("magic-read-content"),
